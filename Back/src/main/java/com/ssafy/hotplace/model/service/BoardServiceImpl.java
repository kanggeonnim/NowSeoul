...
import com.ssafy.hotplace.model.repository.BoardRepository;
...
public class BoardServiceImpl implements BoardService {
	...
	public void writeArticle(BoardDto boardDto) throws Exception {
		...
		if (fileInfos != null && !fileInfos.isEmpty()) {
			boardRepository.registerFile(boardDto);
		}
	}
...
//		List<FileInfoDto> fileList = boardRepository.fileInfoList(articleNo);
//		boardRepository.deleteFile(articleNo);
