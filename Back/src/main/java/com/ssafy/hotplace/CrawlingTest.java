...
//		System.setProperty("webdriver.chrome.driver","/SSAFY/chromedriver-win64/chromedriver.exe");
		...
		// mac
		System.setProperty("webdriver.chrome.driver","/Users/kanggeon/workspace/SSAFY/NowSeoul/chromedriver-mac-arm64/chromedriver");
...
//		File f = new File("c://yangyu//test"+threadNum+".txt");
		...
		// mac
		File f = new File("/Users/kanggeon/workspace/dummy/"+threadNum+".txt");
		f.createNewFile();
